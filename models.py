...
class Flavoring(Base):
  ...
  ratio: Mapped[float] = mapped_column(Numeric(6, 5))
...
class NicProfile(Base):
  ...
  target_nic_str: Mapped[float] = mapped_column(Numeric(6, 5))
  target_vg: Mapped[float] = mapped_column(Numeric(6, 5))
  target_pg: Mapped[float] = mapped_column(Numeric(6, 5))
  nic_base_nic_str: Mapped[float] = mapped_column(Numeric(6, 5))
